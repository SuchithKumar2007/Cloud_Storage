          ...
          <div className="flex items-center justify-between">
            <label className="flex items-center gap-2 cursor-pointer select-none">
              <div className="relative">
                ...
                />
                <div className="w-9 h-5 bg-gray-200 dark:bg-gray-700 rounded-full peer peer-checked:bg-brand-500 transition-colors"></div>
              ...
              <span className="text-xs font-medium text-gray-600 dark:text-gray-400">Remember me</span>
            </label>
            <button
              type="button"
